! function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define("DevTools", [], t) : "object" == typeof exports ? exports.DevTools = t() : e.DevTools = t()
}(window, function() {
    return function(e) {
        var t = {};
        ...
        var u = n(1),
            ...
            f = new(function() {
                function e() {}
                return e.prototype.freezeWhenDevToolsOpened = function(e) {
                    e ? u.default.sharedInstance().startMonitoringDebuggerAttach() : u.default.sharedInstance().stopMonitoringDebuggerAttach()
                }, e.prototype.alwaysConsoleClear = function(e) {
                    e ? a.default.sharedInstance().enableAlwaysClearConsole() : a.default.sharedInstance().disableAlwaysClearConsole()
                ...
                }, r([c.CheckRequiredParameters, i(0, c.Required), o("design:type", Function), o("design:paramtypes", [Boolean]), o("design:returntype", void 0)], e.prototype, "freezeWhenDevToolsOpened", null), r([c.CheckRequiredParameters, i(0, c.Required), o("design:type", Function), o("design:paramtypes", [Boolean]), o("design:returntype", void 0)], e.prototype, "alwaysConsoleClear", null), r([c.CheckRequiredParameters, i(0, c.Required), o("design:type", Function), o("design:paramtypes", [Function]), o("design:returntype", void 0)], e.prototype, "startDevToolMonitoring", null), r([c.CheckRequiredParameters, o("design:type", Function), o("design:paramtypes", []), o("design:returntype", void 0)], e.prototype, "stopDevToolMonitoring", null), e
            }());
        t.Manager = f
        ...
        var DebuggerManager = function() {
            ...
            return DebuggerManager.sharedInstance = function() {
                return null === DebuggerManager.debuggerManager && (DebuggerManager.debuggerManager = new DebuggerManager), DebuggerManager.debuggerManager
            }, DebuggerManager.prototype.startMonitoringDebuggerAttach = function() {
                null === this.debuggerTimer ? this.debuggerTimer = setInterval(function() {
                    eval("debugger")
                }, 10) : console.warn("Monitoring timer already running.")
            }, DebuggerManager.prototype.stopMonitoringDebuggerAttach = function() {
                null !== this.debuggerTimer ? clearInterval(this.debuggerTimer) : console.warn("Not running monitoring timer. Did you call startMonitoringDebuggerAttach() method before calling it?")
            }, DebuggerManager.debuggerManager = null, DebuggerManager
        }();
        ...
        var r = function() {
            ...
            return e.sharedInstance = function() {
                return null === e.consoleManager && (e.consoleManager = new e), e.consoleManager
            }, e.prototype.enableAlwaysClearConsole = function() {
                null === this.timerHandle && (this.timerHandle = setInterval(function() {
                    // console.clear()
                }, 1e3))
            }, e.prototype.disableAlwaysClearConsole = function() {
                null !== this.timerHandle && clearInterval(this.timerHandle)
            }, e.consoleManager = null, e
        }();
        t.default = r
    }, function(e, t, n) {
        "use strict";
        ...
        var r = function() {
            function e() {
                this.monitoringTimer = null, this.isDevtoolOpened = !1, this.consoleDirection = "", this.threshold = 150
            }
            return e.sharedInstance = function() {
                return null === e.devToolsManager && (e.devToolsManager = new e), e.devToolsManager
            }, e.prototype.startMonitoringDevTools = function(e) {
                var t = this;
                null === this.monitoringTimer ? this.monitoringTimer = setInterval(function() {
                    t.monitoringTimerHandler(e)
                }, 1e3) : console.warn("Already started monitoring dev tools!!")
            }, e.prototype.stopMonitoringDevTools = function() {
                null !== this.monitoringTimer ? clearInterval(this.monitoringTimer) : console.warn("Not started monitoring dev tools!!")
            }, e.prototype.monitoringTimerHandler = function(e) {
                var t = !1,
                    n = !1;
                if (window.Firebug && window.Firebug.chrome && window.Firebug.chrome.isInitialized && (n = !0, t = !0), !t) {
                    var r = /./;
                    r.toString = function() {
                        n = !0, t = !0
                    }, console.log("%c", r) 
                ...
                t || void 0 !== console.profiles && null !== console.profiles && (console.profile(), console.profileEnd(), console.profiles.length > 0 && (n = !0, t = !0));
                ...
                u = !n || o || i ? u : "seperated-window", u = n ? u : "closed", t || (o || i) && (n = !0), this.isDevtoolOpened === n && this.consoleDirection === u || (this.isDevtoolOpened = n, this.consoleDirection = u, e(this.isDevtoolOpened, u))
            }, e.devToolsManager = null, e
        }();
        t.default = r
    }, function(e, t, n) {
        "use strict";
            ...
            n.value = function() {
                ...
                if (n)
                    for (var i = 0, u = n; i < u.length; i++) {
                        var a = u[i];
                        if (a >= arguments.length || void 0 === arguments[a]) throw new Error("Missing parameters " + t + " method.")
                    }
                ...
                ! function(r) {
                    ...
                    void 0 === o.Reflect ? o.Reflect = n : i = u(o.Reflect, i),
                        function(t) {
                            ...
                            instanceof Array, s = !u && !a, c = {
                            ...
                            }, f = Object.getPrototypeOf(Function), l = "object" == typeof e && e.env && "true" === e.env.REFLECT_METADATA_USE_MAP_POLYFILL, p = l || "function" != typeof Map || "function" != typeof Map.prototype.entries ? function() {
                                var e = {},
                                    t = [],
                                    n = function() {
                                        function e(e, t, n) {
                                ...
                                function a() {
                                    var t = function(e) {
                                        if ("function" == typeof Uint8Array) return "undefined" != typeof crypto ? crypto.getRandomValues(new Uint8Array(e)) : "undefined" != typeof msCrypto ? msCrypto.getRandomValues(new Uint8Array(e)) : u(new Uint8Array(e), e);
