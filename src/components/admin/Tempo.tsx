...
var all_genres: any[] = [];
if(tempo.length!=0){
    all_genres = Object.keys(tempo).map(function(key: any,value:any) {
    return <tr key={key}>
         <td>{parseInt(key)+1}</td> 
       
        <td>{tempo[key]['tempo_name']}</td>
       ...
       <td>
         <div className="dropdown">
            ...
            <li><a href={`/admin/edit_tempo/`+tempo[key]['_id']}>Edit</a></li>
  ...
  <div className="user_table">
       <div className="row">
        ...
        <h3>Tempo</h3>
        <span><a  className="btn btn_admin" href="/admin/add_tempo">Add Tempo</a></span>
        </div>
